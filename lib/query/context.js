...
lf.query.Context = function(schema) {
  /** @type {number} */
  this.contextId = lf.query.ContextId_++;
...
lf.query.Context.prototype.cloneBase = function(context) {
  ...
  console.log('context', this.contextId, 'cloned from', context.contextId);
};
...
lf.query.Context.prototype.bind = function(values) {
  ...
  console.log('context', this.contextId, 'bind', values);
  return this;
};
